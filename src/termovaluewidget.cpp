    ...
    QWidget(parent)
{
    ...
    form = 1;
    formBut = new QPushButton(colinIcons::instance().icon(ColinLoad::tempChange), "", this);
...
void termoValueWidget::typChanged()
{
    ...
    {
        form = 2;
        formBut->setIcon(colinIcons::instance().icon(ColinLoad::tempDiffrence));
    }
    else
    {
        form = 1;
        formBut->setIcon(colinIcons::instance().icon(ColinLoad::tempChange));
    }
}
